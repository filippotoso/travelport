...
class AirPricingInfo
{
     ...
     */
    public function __construct($FareInfo, $FareStatus, $FareInfoRef, $BookingInfo, $TaxInfo, $FareCalc, $PassengerType, $BookingTravelerRef, $WaiverCode, $PaymentRef, $FeeInfo, $Adjustment, $Yield, $AirPricingModifiers, $TicketingModifiersRef, $AirSegmentPricingModifiers, $FlightOptionsList, $BaggageAllowances, $FareRulesFilter, $PolicyCodesList, $ActionDetails, $Commission, $Origin, $Destination, $Key, $CommandKey, $AmountType, $IncludesVAT, $ExchangeAmount, $ForfeitAmount, $Refundable, $Exchangeable, $LatestTicketingTime, $PricingMethod, $Checksum, $ETicketability, $PlatingCarrier, $ProviderReservationInfoRef, $AirPricingInfoGroup, $TotalNetPrice, $Ticketed, $PricingType, $TrueLastDateToTicket, $FareCalculationInd, $Cat35Indicator, $TotalPrice, $BasePrice, $ApproximateTotalPrice, $ApproximateBasePrice, $EquivalentBasePrice, $Taxes, $Fees, $Services, $ApproximateTaxes, $ApproximateFees, $ProviderCode, $SupplierCode, $ElStat, $KeyOverride, $InPolicy, $PreferredOption)
    {
