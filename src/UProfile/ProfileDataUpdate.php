...
class ProfileDataUpdate
{
     ...
     */
    public function __construct($AgencyGroupInfo, $AgencyInfo, $BranchGroupInfo, $BranchInfo, $AgentInfo, $AccountInfo, $TravelerGroupInfo, $TravelerInfo, $Address, $Phone, $ElectronicAddress, $TravelerIdentityInformation, $ExternalIdentifier, $TravelDocument, $AccountingReference, $PolicyReference, $LoyaltyProgramEnrollment, $Commission, $Contract, $ServiceFee, $AlternateContact, $AlternateContactAddress, $AlternateContactPhone, $AlternateContactElectronicAddress, $FormOfPayment, $AirPreference, $HotelPreference, $OtherPreference, $Remark, $FieldData, $FieldGroupData, $VehiclePreference, $Advisory, $CommissionReference, $RailPreference, $ProprietaryData)
    {
