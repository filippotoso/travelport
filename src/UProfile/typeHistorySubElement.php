...
class typeHistorySubElement extends typeAddressHistory
{
     ...
     */
    public function __construct($Key, $TagRef, $AddressLine, $City, $State, $OtherStateProvince, $Country, $Postal, $Type, $Purpose, $Provisioned, $PriorityOrder, $DeliveryDescription, $OwnerID, $AccountInfo, $TravelerInfo, $TravelDocument, $AccountingReference, $PolicyReference, $CommissionReference, $LoyaltyProgramEnrollment, $Contract, $Commission, $ServiceFee, $AlternateContact, $AlternateContactAddress, $AlternateContactPhone, $AlternateContactElectronicAddress, $FormOfPayment, $Remark, $Address, $Phone, $ElectronicAddress, $TravelerIdentityInformation, $ExternalIdentifier, $AirPreference, $VehiclePreference, $HotelPreference, $RailPreference, $ProfileParentHistory, $FieldData, $FieldGroupData, $Advisory, $AgencyGroupInfo, $AgencyInfo, $BranchGroupInfo, $BranchInfo, $AgentInfo, $TravelerGroupInfo, $ProfileStatus, $ProfileLink, $ProviderInfo, $OtherPreference, $ProprietaryData)
    {
