...
class typeRailPreferenceHistory extends typeBasePreferenceHistory
{
     ...
     */
    public function __construct($Key, $BookingStartDate, $BookingEndDate, $Currency, $DepartureGeoPoliticalAreaType, $DepartureGeoPoliticalAreaCode, $Emphasis, $GeneralPreference, $Inclusive, $LoyaltyProgramEnrollmentRef, $OtherLoyaltyProgramNumber, $PaymentDetailsRef, $PreferencePaymentMethod, $Purpose, $PriorityOrder, $Supplier, $TripApproval, $CabinType, $DomesticTripJourneyHours, $EndingTrainNumber, $InternationalTripJourneyHours, $MaxEmployeesPerTrain, $MaxFareAmount, $GenderCompartmentType, $CoachCompartmentType, $SeatArrangementType, $SeatingType, $Smoking, $StartingTrainNumber, $TicketFulfillmentType, $AccountCode, $ArrivalGeoPoliticalAreaType, $ArrivalGeoPoliticalAreaCode, $BenchMarkAmount, $ConnectionGeoPoliticalAreaType, $ConnectionGeoPoliticalAreaCode, $ContractCode, $CorporateID, $PseudoCityCode, $TravelStartDate, $TravelEndDate, $SeatPositionMiscTravel, $SeatPositionRefCategory)
    {
