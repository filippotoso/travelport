...
class RailPreference extends typeBasePreference
{
     ...
     */
    public function __construct($Key, $TagRef, $BookingStartDate, $BookingEndDate, $Currency, $DepartureGeoPoliticalAreaType, $DepartureGeoPoliticalAreaCode, $Emphasis, $GeneralPreference, $Inclusive, $LoyaltyProgramEnrollmentRef, $OtherLoyaltyProgramNumber, $PaymentDetailsRef, $PreferencePaymentMethod, $Purpose, $PriorityOrder, $Supplier, $TripApproval, $DomesticTripJourneyHours, $StartingTrainNumber, $EndingTrainNumber, $InternationalTripJourneyHours, $MaxEmployeesPerTrain, $MaxFareAmount, $CabinType, $GenderCompartmentType, $CoachCompartmentType, $SeatArrangementType, $SeatingType, $Smoking, $TicketFulfillmentType, $AccountCode, $ArrivalGeoPoliticalAreaType, $ArrivalGeoPoliticalAreaCode, $BenchMarkAmount, $ConnectionGeoPoliticalAreaType, $ConnectionGeoPoliticalAreaCode, $ContractCode, $CorporateID, $PseudoCityCode, $TravelStartDate, $TravelEndDate, $SeatPositionMiscTravel, $SeatPositionRefCategory)
    {
