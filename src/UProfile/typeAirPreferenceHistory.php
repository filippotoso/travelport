...
class typeAirPreferenceHistory extends typeBasePreferenceHistory
{
     ...
     */
    public function __construct($Key, $BookingStartDate, $BookingEndDate, $Currency, $DepartureGeoPoliticalAreaType, $DepartureGeoPoliticalAreaCode, $Emphasis, $GeneralPreference, $Inclusive, $LoyaltyProgramEnrollmentRef, $OtherLoyaltyProgramNumber, $PaymentDetailsRef, $PreferencePaymentMethod, $Purpose, $PriorityOrder, $Supplier, $TripApproval, $AirFareType, $CRSCode, $EndingFlightNumber, $FareType, $Interline, $MaxFareAmount, $MaxConnectionMinutes, $MaxDomesticTripHours, $MaxEmployeesPerFlight, $MaxInternationalTripHours, $MealTypeCRS, $MealTypeSSR, $SeatNumber, $SSRCode, $StartingFlightNumber, $AccountCode, $ArrivalGeoPoliticalAreaType, $ArrivalGeoPoliticalAreaCode, $BenchMarkAmount, $ConnectionGeoPoliticalAreaType, $ConnectionGeoPoliticalAreaCode, $ContractCode, $CorporateID, $PseudoCityCode, $TravelStartDate, $TravelEndDate, $CabinTypeMiscTravel, $CabinTypeRefCategory, $SeatTypeMiscTravel, $SeatTypeMiscRefCategory)
    {
