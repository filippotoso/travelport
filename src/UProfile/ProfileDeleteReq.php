...
class ProfileDeleteReq extends BaseReq
{
     ...
     * @param boolean $Force
     */
    public function __construct($BillingPointOfSaleInfo, $AgentIDOverride, $TerminalSessionInfo, $TraceId, $TokenId, $AuthorizedBy, $TargetBranch, $OverrideLogging, $LanguageCode, $OverridePCC, $RetrieveProviderReservationDetails, $ProfileID, $ProvisioningCode, $UniqueProfileID, $Force)
    {
