...
class VehicleCreateReservationReq extends BaseCreateWithFormOfPaymentReq
{
     ...
     */
    public function __construct($BillingPointOfSaleInfo, $AgentIDOverride, $TerminalSessionInfo, $TraceId, $TokenId, $AuthorizedBy, $TargetBranch, $OverrideLogging, $LanguageCode, $OverridePCC, $RetrieveProviderReservationDetails, $LinkedUniversalRecord, $BookingTraveler, $OSI, $AccountingRemark, $GeneralRemark, $XMLRemark, $UnassociatedRemark, $Postscript, $PassiveInfo, $ContinuityCheckOverride, $AgencyContactInfo, $CustomerID, $FileFinishingInfo, $CommissionRemark, $ConsolidatorRemark, $InvoiceRemark, $SSR, $EmailNotification, $QueuePlace, $RuleName, $UniversalRecordLocatorCode, $ProviderLocatorCode, $ProviderCode, $CustomerNumber, $Version, $FormOfPayment, $VehicleDateLocation, $Vehicle, $SpecialEquipment, $VehicleSpecialRequest, $PaymentInformation, $PointOfSale, $DeliveryAddress, $CollectionAddress, $FlightArrivalInformation, $Guarantee, $AssociatedRemark, $BookingSource, $ReservationName, $ThirdPartyInformation, $ActionStatus, $ReviewBooking, $MandatoryRateMatch)
    {
