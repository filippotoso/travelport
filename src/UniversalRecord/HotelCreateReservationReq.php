...
class HotelCreateReservationReq extends BaseCreateWithFormOfPaymentReq
{
     ...
     */
    public function __construct($BillingPointOfSaleInfo, $AgentIDOverride, $TerminalSessionInfo, $TraceId, $TokenId, $AuthorizedBy, $TargetBranch, $OverrideLogging, $LanguageCode, $OverridePCC, $RetrieveProviderReservationDetails, $LinkedUniversalRecord, $BookingTraveler, $OSI, $AccountingRemark, $GeneralRemark, $XMLRemark, $UnassociatedRemark, $Postscript, $PassiveInfo, $ContinuityCheckOverride, $AgencyContactInfo, $CustomerID, $FileFinishingInfo, $CommissionRemark, $ConsolidatorRemark, $InvoiceRemark, $SSR, $EmailNotification, $QueuePlace, $RuleName, $UniversalRecordLocatorCode, $ProviderLocatorCode, $ProviderCode, $CustomerNumber, $Version, $FormOfPayment, $HotelRateDetail, $HotelProperty, $ThirdPartyInformation, $HotelStay, $Guarantee, $HotelSpecialRequest, $PointOfSale, $PromotionCode, $BookingSource, $HotelBedding, $GuestInformation, $AssociatedRemark, $ReservationName, $ActionStatus, $HostToken, $ReviewBooking, $HotelCommission, $BookingGuestInformation, $UserAcceptance, $MandatoryRateMatch, $StatusCode, $BookingConfirmation)
    {
