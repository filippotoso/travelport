...
class UniversalRecordSearchReq extends BaseReq
{
     ...
     */
    public function __construct($BillingPointOfSaleInfo, $AgentIDOverride, $TerminalSessionInfo, $TraceId, $TokenId, $AuthorizedBy, $TargetBranch, $OverrideLogging, $LanguageCode, $OverridePCC, $RetrieveProviderReservationDetails, $UniversalRecordSearchModifiers, $TravelerCriteria, $SearchAgent, $AirReservationCriteria, $HotelReservationCriteria, $VehicleReservationCriteria, $RailReservationCriteria, $SearchAccount, $ActionDate, $RecordStatus, $ClientId, $ProviderCode, $ProviderLocatorCode, $ExternalSearchIndex, $RestrictToProfileId, $PassiveOnly, $TicketStatus)
    {
