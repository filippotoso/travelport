...
class ServiceFeeInfo
{
     ...
     */
    public function __construct($FormOfPayment, $ServiceFeeTaxInfo, $CreditCardAuth, $Payment, $Status, $Description, $Key, $Confirmation, $TicketNumber, $BookingTravelerRef, $ProviderReservationInfoRef, $PassiveProviderReservationInfoRef, $TotalAmount, $BaseAmount, $Taxes, $ElStat, $KeyOverride)
    {
