...
class typeFeeInfo
{
     ...
     */
    public function __construct($BaseAmount, $Description, $SubCode, $Key, $Amount, $Code, $FeeToken, $PaymentRef, $BookingTravelerRef, $PassengerTypeCode, $ProviderCode, $SupplierCode, $ElStat, $KeyOverride)
    {
