...
class AirPricePoint
{
     ...
     */
    public function __construct($AirPricingInfo, $FeeInfo, $FareNote, $TaxInfo, $Key, $CompleteItinerary, $TotalPrice, $BasePrice, $ApproximateTotalPrice, $ApproximateBasePrice, $EquivalentBasePrice, $Taxes, $Fees, $Services, $ApproximateTaxes, $ApproximateFees)
    {
