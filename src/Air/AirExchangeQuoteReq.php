...
class AirExchangeQuoteReq extends BaseAirExchangeQuoteReq
{
     ...
     */
    public function __construct($BillingPointOfSaleInfo, $AgentIDOverride, $TerminalSessionInfo, $TraceId, $TokenId, $AuthorizedBy, $TargetBranch, $OverrideLogging, $LanguageCode, $TicketNumber, $AirPricingSolution, $AirExchangeModifiers, $HostToken, $OptionalServices, $FormOfPayment, $RepricingModifiers, $OriginalItineraryDetails, $PCC, $FareRuleType)
    {
